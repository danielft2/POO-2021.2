...
void fimDeJogo(Board& loser, sf::RenderWindow& window, int& controll, int& controllFase) {
...
int main() {
    ...
    sf::Texture deserto_tex { loadTexture("desrto2.jpg") };
    ...
    while (window.isOpen()) {
        ...
        if (controllVida < 1 && fase > 3) {
            fimDeJogo(loser, window, controllVida, fase);
        }
